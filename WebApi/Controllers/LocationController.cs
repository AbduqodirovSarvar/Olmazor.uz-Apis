...
using Application.UseCases.LocationToDoList.Queries;
using MediatR;
...
namespace WebApi.Controllers
{
        ...
        ) : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] GetLocationQuery query)
        {
            try
            {
        ...
        [HttpDelete]
        public async Task<IActionResult> Delete(DeleteLocationCommand command)
        {
            try
            {
                return Ok(await _mediator.Send(command));
